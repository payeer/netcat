/* Payeer */
define("NETCAT_MODULE_PAYMENT_PAYEER_ERROR_MERCHANT_URL_IS_NOT_VALID", "Не указан URL мерчанта");
define("NETCAT_MODULE_PAYMENT_PAYEER_ERROR_MERCHANT_ID_IS_NOT_VALID", "Не указан идентификатор магазина");
define("NETCAT_MODULE_PAYMENT_PAYEER_ERROR_SECRET_KEY_IS_NOT_VALID", "Не указан секретный ключ магазина");
define("NETCAT_MODULE_PAYMENT_PAYEER_MSG_NOT_VALID_IP", " - IP сервера уведомлений не является доверенным");
define("NETCAT_MODULE_PAYMENT_PAYEER_MSG_VALID_IP", "   доверенные IP: ");
define("NETCAT_MODULE_PAYMENT_PAYEER_MSG_THIS_IP", "   IP текущего сервера: ");
